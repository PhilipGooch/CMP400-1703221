...
const int number_of_particles = 2048;

const int scale = 1;     // Manipulates environment size, zoom of camera and point size.
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("GPU Brute Force. 4096 Particles.");
    ...
    sph = new SPH(number_of_particles, scale);
